...
public class VehicleDto {
	...
	public String toString() {
		return "[Disponible="+this.isDisponible()+";idRemote="+this.getIdRemote()+"] Véhicule n°"+this.getId()+" Type:"+this.getType()+", Coords:(lat="+this.getLat()+";"+this.getLon()+"), Efficacité:"+this.getEfficiency()+", Fuel:"+this.getFuel()+", FuelConsumption:"+this.getFuelConsumption()+", LiquidType:"+this.getLiquidType()+", LiquidQuantity:"+this.getLiquidQuantity()+", LiquidConsumption:"+this.getLiquidConsumption()+", CrewMembers:"+this.getCrewMember()+", CrewMemberCapacity:"+this.getCrewMemberCapacity()+", n° caserne:"+this.getFacilityRefID();
	}
