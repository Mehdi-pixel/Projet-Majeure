...
function TOMYCOLLECTION(vType,lType){
...
function AFINEADDITION() {
  ...
  fetch("http://localhost:8084/vehicle", {method:'POST', body: TOMYCOLLECTION(vType,lType),headers: new Headers({'content-type': 'application/json'})})
